...
const defaultStyles = {
  ...
  singleValue: base => ({
    ...
    color: '#f3f4f6',
    fontWeight: 600,
    textShadow: '0 1px 8px rgba(162,28,175,0.10)',
  }),
...
export default function CgpaFilter({ value, onChange, options = [], variant = 'default' /* 'default' or 'minimal' */ }) {
  const formattedOptions = options.map(opt => (
    typeof opt === 'object' && opt.value !== undefined ? 
